...
router.get("/integrations",(req,res)=>{const settings=readJson("settings",{ga4Id:process.env.GA4_MEASUREMENT_ID||"",clarityId:process.env.CLARITY_PROJECT_ID||"",gscVerified:!!process.env.GSC_VERIFIED,sitemapUrl:`${process.env.SITE_URL||"https://cardoria-site-f2cy.onrender.com"}/sitemap.xml`,robotsUrl:`${process.env.SITE_URL||"https://cardoria-site-f2cy.onrender.com"}/robots.txt`,seoAuto:true});res.json({ok:true,settings});});
