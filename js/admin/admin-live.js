(function () {
  ...
  A.qs("#liveCreate").onclick = function () {
    var b = this;
    b.disabled = true;
    A.adminFetch("/api/admin/live/sessions", { method: "POST", body: JSON.stringify({ title: A.qs("#liveTitle").value, ownerRole: "admin", category: (A.qs("#liveCategory") && A.qs("#liveCategory").value) || "other", products:[] }) }).then(function (d) {
