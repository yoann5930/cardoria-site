/**
 * Panier marketplace — validation prix serveur et creation de commandes par vendeur.
 */
...
/** Cree une commande atomique par vendeur. */
  ...
  try {
    sellerIds.forEach((sellerId) => {
      ...
      const order = createOrder({
        ...
        items: lines.map((line) => ({ listingId: line.listingId, qty: line.qty })),
        buyerEmail,
        buyerName,
