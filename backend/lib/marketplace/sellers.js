...
function toSeller(row) {
  ...
  return {
    ...
    planId: subscription.active ? subscription.planId : "",
    planStatus: subscription.status,
    planStartedAt: subscription.planStartedAt,
    subscriptionActive: subscription.active,
    marketplaceOfferLinked: row.seller_type === "professional" && subscription.active,
    marketplaceOfferPlanId: row.seller_type === "professional" && subscription.active ? subscription.planId : "",
    marketplaceOffer: row.seller_type === "professional" && subscription.active ? subscription.entitlements?.marketplace || null : null,
