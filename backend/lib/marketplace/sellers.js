...
function toSeller(row) {
  ...
  return {
    ...
    marketplaceOfferLinked: subscription.active,
    marketplaceOfferPlanId: subscription.active ? subscription.planId : "",
    marketplaceOffer: subscription.active ? subscription.entitlements?.marketplace || null : null,
