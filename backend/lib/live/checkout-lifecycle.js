...
export const UNSETTLED_LIVE_PAYMENT_STATUSES = new Set([
  "creating", "pending", "authorized", "authorised", "reconciliation_required", "refund_reconciliation_required"
]);
...
export function assertExistingCheckoutReusable(checkout) {
  ...
  if (["creating", "reconciliation_required", "refund_reconciliation_required", "refunded"].includes(status)) {
