(function () {
  ...
  M.api("/v1/sellers/" + encodeURIComponent(seller.id) + "/orders").then(function (d) {
    root.innerHTML = "<p><strong>" + M.esc(seller.displayName) + "</strong> " + M.sellerBadge(seller) + "</p><p><a href='mes-annonces.html'>Mes annonces</a> · <a href='vendre.html'>Publier</a> · <a href='live-vendeur.html'>Live vendeur (PayPal)</a></p><h2>Commandes à traiter</h2>" + (d.orders || []).map(function (o) {
